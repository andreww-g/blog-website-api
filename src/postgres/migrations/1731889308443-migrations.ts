...
export class Migrations1731889308443 implements MigrationInterface {
  ...
  public async up (queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('ALTER TABLE "article" ADD CONSTRAINT "article__publisher_id__f_key" FOREIGN KEY ("publisher_id") REFERENCES "publishers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION');
    ...
    await queryRunner.query('ALTER TABLE "publishers" ADD CONSTRAINT "publisher__author_id__f_key" FOREIGN KEY ("authorId") REFERENCES "authors"("id") ON DELETE NO ACTION ON UPDATE NO ACTION');
  ...
  public async down (queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('ALTER TABLE "publishers" DROP CONSTRAINT "publisher__author_id__f_key"');
